...
def configure_recipe(nodes: int = 1, gpus_per_node: int = 8):
    ...
    recipe.data.tokenizer = run.Config(AutoTokenizer, "./models--Qwen--Qwen2.5-72B/snapshots/efba10c8e54e91e0d9570ab5f7b51a958474d4cb")
...
def run_pretraining():
    ...
    run.run(recipe, executor=executor, name="qwen25_72b_pretraining")
