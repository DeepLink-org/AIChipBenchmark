from long_tail_bench.common import SampleConfig, SampleSource, SampleTag
import numpy as np
...
def get_sample_config():
    return SampleConfig(
        ...
        url=
        "https://github.com/open-mmlab/mmdetection/blob/c76ab0eb3c637b86c343d8454e07e00cfecc1b78/mmdet/models/losses/ae_loss.py#L11",  # noqa
        tags=[
            SampleTag.Reduce,
