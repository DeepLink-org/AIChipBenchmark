...
def get_sample_config():
    return SampleConfig(
        ...
        url=
        "https://gitlab.bj.sensetime.com/platform/ParrotsDL/pytorch-object-detection/-/blob/master/pod/models/heads/fcos_head/fcos.py#L156",  # noqa
        tags=[
            SampleTag.ViewAttribute, SampleTag.IfElseBranch, SampleTag.Reduce,
            SampleTag.AdvancedIndexing, SampleTag.ForLoop
        ])
