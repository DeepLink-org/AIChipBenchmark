...
def get_sample_config():
    return SampleConfig(
        ...
        url=
        "https://github.com/open-mmlab/mmdetection/blob/bde7b4b7eea9dd6ee91a486c6996b2d68662366d/mmdet/models/losses/pisa_loss.py#L123",  # noqa
        tags=[
            SampleTag.InputAware, SampleTag.ViewAttribute,
            SampleTag.IfElseBranch, SampleTag.BuiltInDataStructure,
