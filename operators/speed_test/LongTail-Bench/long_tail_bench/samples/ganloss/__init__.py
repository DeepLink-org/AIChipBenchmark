from long_tail_bench.common import (SampleConfig, auto_import, SampleSource,
                                    SampleTag)
...
def get_sample_config():
    return SampleConfig(
        ...
        url=
        "https://github.com/open-mmlab/mmediting/blob/23213c839ff2d1907a80d6ea29f13c32a24bb8ef/mmedit/models/losses/gan_loss.py#L75",  # noqa
