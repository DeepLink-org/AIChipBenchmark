...
def get_sample_config():
    return SampleConfig(
        ...
        url=
        "https://github.com/open-mmlab/mmdetection/blob/c76ab0eb3c637b86c343d8454e07e00cfecc1b78/mmdet/core/bbox/samplers/random_sampler.py#L9",  # noqa
        tags=[
...
def gen_np_args(N):
    ...
    gt_boxes = gt_boxes.astype(np.float16)
