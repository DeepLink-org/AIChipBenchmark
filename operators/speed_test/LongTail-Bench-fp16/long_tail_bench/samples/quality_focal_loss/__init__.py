...
def get_sample_config():
    return SampleConfig(
        ...
        url=
        "https://github.com/open-mmlab/mmdetection/blob/c76ab0eb3c637b86c343d8454e07e00cfecc1b78/mmdet/models/losses/gfocal_loss.py#L12",  # noqa
        tags=[SampleTag.InputAware, SampleTag.AdvancedIndexing],
    )
