...
def get_sample_config():
    return SampleConfig(
        ...
        url=
        "https://github.com/open-mmlab/mmcv/blob/add157cc73b05c7be3d9b63505e17dc2288a6d0f/mmcv/ops/nms.py#L260",  # noqa
        tags=[
...
def gen_np_args(N):
    ...
    idxs = np.random.randint(0, 5, (N, ))
    # idxs = idxs.astype(np.float16)
