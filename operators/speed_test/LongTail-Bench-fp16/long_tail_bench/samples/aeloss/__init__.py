...
def get_sample_config():
    return SampleConfig(
        ...
        url=
        "https://github.com/open-mmlab/mmpose/blob/c0d5e4c2b39a1ebeca4be2c6c6358c33a9a5012d/mmpose/models/losses/multi_loss_factory.py#L68",  # noqa
...
def gen_np_args(K, W, H):
    ...
    pred_tag = pred_tag.astype(np.float16)
    shape2 = (4, K, 2)
    joints = np.random.randint(0, 1, shape2)
    joints = joints.astype(np.float16)
