...
with read_base():
    ...
    from configs._base_.models.llama.llama_70B import *  # pylint: disable=wildcard-import,unused-wildcard-import
...
SAVE_CKPT_FOLDER = "local:/mnt/hwfile/share_data/huangye.p/train_internlm/70B_ckpt/"

# If you want to train from scratch, set LOAD_CKPT_FOLDER to None.
#LOAD_CKPT_FOLDER = "local:/mnt/hwfile/share_data/huangye.p/train_internlm/70B_ckpt/snapshot/1"
LOAD_CKPT_FOLDER = "local:/mnt/hwfile/share_data/huangye.p/train_internlm/70B_ckpt/7220"
...
LOAD_CKPT_FOLDER_INFO = dict(path=LOAD_CKPT_FOLDER, content=["all"], ckpt_type="internlm")
...
parallel = dict(zero1=dict(size=-1, fsdp=False), pipeline=dict(size=4, interleaved_overlap=True), tensor=8, sequence_parallel=False)
