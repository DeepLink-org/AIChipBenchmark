...
def main():
    ...
    coordinator.print_on_master(f"====== dp_size={dp_size}, args.batch_size={args.batch_size}, args.num_steps={args.num_steps}, max_length={args.max_length}")
    ...
    if isinstance(plugin, HybridParallelPlugin) and args.pp > 1:
        coordinator.print_on_master(f"====== plugin is HybridParallelPlugin, len(dataloader)={len(dataloader)}")
        ...
        coordinator.print_on_master(f"====== pp=1, len(dataloader)={len(dataloader)}")
