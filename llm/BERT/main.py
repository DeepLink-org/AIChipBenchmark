...
def train():
    ...
    parser.add_argument("--ckpt", type=str, default=None, help="initial model")
    ...
    train_dataset = BERTDataset(args.train_dataset, seq_len=args.seq_len,
                                corpus_lines=args.corpus_lines, on_memory=args.on_memory)

    print("Loading Test Dataset", args.test_dataset)
    test_dataset = BERTDataset(args.test_dataset, seq_len=args.seq_len, on_memory=args.on_memory) \
    ...
    trainer = BERTTrainer(bert, 30522, train_dataloader=train_data_loader, test_dataloader=test_data_loader,
                          ckpt_path=args.ckpt,lr=args.lr, betas=(args.adam_beta1, args.adam_beta2), weight_decay=args.adam_weight_decay,
