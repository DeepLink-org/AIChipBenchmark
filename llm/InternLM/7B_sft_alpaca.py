...
MODEL_ONLY_FOLDER = "local:/mnt/lustre/share_data/PAT/datasets/internlm-weight/InternLM-7b"
# Ckpt folder format:
...
TRAIN_FOLDER = "/mnt/cache/dongkaixing1.vendor/llm/InternLM/stanford_alpaca/train/en"
VALID_FOLDER = "/mnt/cache/dongkaixing1.vendor/llm/InternLM/stanford_alpaca/valid/en"
data = dict(
    seq_len=SEQ_LEN,
