...
def configure_recipe(nodes: int = 1, gpus_per_node: int = 8):
    ...
    recipe = llm.qwen25_7b.pretrain_recipe(num_nodes=nodes, num_gpus_per_node=gpus_per_node,
    ...
    recipe.data=run.Config(
            ...
            paths="./qwen25_7b/arxiv_sample_text_document",
            seq_length=8192,
            micro_batch_size=data_bak.micro_batch_size,
            global_batch_size=data_bak.global_batch_size,
            tokenizer=run.Config(AutoTokenizer, "./models--qwen25--7B/snapshots/09a0bac5707b43ec44508eab308b0846320c1ed4"),
            split='900,50,50',
            seed=2025,
    )
...
def run_pretraining():
    ...
    run.run(recipe, executor=executor, name="qwen25_7b_pretraining")
