...
file_client_args = dict(
    ...
    path_mapping=dict({
        '.data/cityscapes/':
        'openmmlab:s3://openmmlab/datasets/segmentation/cityscapes/',
        'data/cityscapes/':
        'openmmlab:s3://openmmlab/datasets/segmentation/cityscapes/'
    }))
...
data = dict(
    ...
    val=dict(
        ...
        gt_seg_map_loader_cfg=dict(file_client_args=dict(
            backend='petrel',
            path_mapping=dict({
                '.data/cityscapes/':
                'openmmlab:s3://openmmlab/datasets/segmentation/cityscapes/',
...
work_dir = 'trainout/DeeplabV3-R50/Node1Device4_precision'
gpu_ids = range(0, 4)
auto_resume = False
